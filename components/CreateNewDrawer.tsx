...
const CreateNewDrawer: React.FC<CreateNewDrawerProps> = ({ onSuccess, tokens }) => {
  ...
  const isGenerateDisabled = loading || prompt.trim().length === 0 || !ageGroup || tokens === 0 || tokens === null;
          ...
          <DrawerFooter className="flex flex-col sm:flex-row gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="w-full flex-1">
                    <Button
                      ...
                      className="w-full flex-1 justify-between items-center text-lg font-semibold color-primary text-white"
                    >
                      {loading ? (
                ...
                {prompt == '' || ageGroup == '' || isGenerateDisabled ? 
                <TooltipContent className='text-white'>
                  {tokens == 0 || tokens === null
                    ? "You don't have enough gems to generate slides"
                    : "Please fill in all fields to generate slides"}
                </TooltipContent> : null}
              </Tooltip>
            </TooltipProvider>
          </DrawerFooter>
